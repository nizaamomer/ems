            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-4" method="POST" action="{{ route('reset.password.post') }}">
                        ...
                        <div>
                            <label for="password"
                                class="block mb-2 text-sm font-medium text-gray-300 dark:text-gray-300">New
                                Password</label>
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block mb-2 text-sm font-medium text-gray-300 dark:text-gray-300">Password
                                Confirmation</label>
