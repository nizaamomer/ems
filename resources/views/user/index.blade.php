                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <div
                                            ...
                                            <span
                                                class="font-medium  text-normal text-gray-600 dark:text-indigo-400">{{ getfirst($user->name) }}</span>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <td class="px-6 py-4 text-center flex justify-evenly space-x-reverse space-x-4 align-middle">
                                ...
                                <div id="deletemodal" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-center space-x-5 space-x-reverse  py-5">
