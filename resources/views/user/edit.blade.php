...
@section('content')
    ...
    <div
        ...
        <form method="post" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label for="Role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">پلە
                    هەڵبژێرە</label>
                <select id="Role" name="Role"
                    ...
                    <option @selected($user->Role == 'admin') value="admin">ئەدمین</option>
                    <option @selected($user->Role == 'viewer') value="viewer">بینەر</option>
                    <option @selected($user->Role == 'recorder') value="recorder">ئیدیتەر</option>
