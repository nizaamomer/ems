...
@section('content')
    <div
        ...
        @endif
        @if (auth()->user()->Role === 'recorder' || auth()->user()->Role === 'admin')
            <a href="{{ route('material.index') }}"
                ...
                <i
                    class="fa-solid fa-boxes-stacked sm:text-4xl text-2xl bg-purple-500  text-gray-300 rounded-md px-4 py-3"></i>
                <div class="text-md sm:text-2xl  text-right text-gray-300 space-y-4">
                    <p>
                        {{ $materials }}
                    </p>
